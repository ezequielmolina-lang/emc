    ...
    <div class="grid lg:grid-cols-12 gap-10 items-center">
      ...
      <div class="lg:col-span-7">
        <div class="inline-flex items-center gap-2.5 glass rounded-full px-5 py-2.5 mb-10" style="animation: slide-up 0.6s ease-out both;">
          ...
          <span class="text-[11px] font-medium text-white/40 tracking-wide">Presidential Innovation Award &mdash; "From Learning to Earning"</span>
        </div>
      ...
      <div class="lg:col-span-5 flex flex-col items-center" style="animation: slide-in-right 0.8s ease-out 0.3s both;">
        <div class="relative">
          ...
          <img src="{GALLITO_IMG}" alt="Gallito de las Rocas" class="relative z-10 h-56 sm:h-64 lg:h-80 w-auto drop-shadow-[0_30px_60px_rgba(245,123,33,0.2)] float-anim">
        </div>
  ...
  <div class="grid lg:grid-cols-2 gap-16 items-start">
    ...
    <div class="order-2 lg:order-2">
      <div data-lang="es">
        ...
        <!-- 8 Steps -->
        <h3 class="reveal font-display font-bold text-dark-400 text-[11px] uppercase tracking-[0.2em] mb-5"><i class="fas fa-route text-brand-400 mr-2"></i>8 Pasos &mdash; 12 sesiones de 60 min</h3>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
          <div class="reveal stagger-1 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">1</span><span class="text-[9px] text-dark-200">Ses. 1-2</span></div><p class="font-display font-bold text-dark-500 text-xs">Autoconocimiento</p></div>
          <div class="reveal stagger-2 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">2</span><span class="text-[9px] text-dark-200">Ses. 3</span></div><p class="font-display font-bold text-dark-500 text-xs">Mitos Vocacionales</p></div>
          <div class="reveal stagger-3 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">3</span><span class="text-[9px] text-dark-200">Ses. 4</span></div><p class="font-display font-bold text-dark-500 text-xs">Test de Intereses RIASEC</p></div>
          <div class="reveal stagger-4 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">4</span><span class="text-[9px] text-dark-200">Ses. 5-6</span></div><p class="font-display font-bold text-dark-500 text-xs">Exploraci&oacute;n de Rutas</p></div>
          <div class="reveal stagger-5 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">5</span><span class="text-[9px] text-dark-200">Ses. 7</span></div><p class="font-display font-bold text-dark-500 text-xs">Explorador Ocupacional</p></div>
          <div class="reveal stagger-6 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">6</span><span class="text-[9px] text-dark-200">Ses. 8-9</span></div><p class="font-display font-bold text-dark-500 text-xs">Investigaci&oacute;n</p></div>
          <div class="reveal stagger-7 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">7</span><span class="text-[9px] text-dark-200">Ses. 10-11</span></div><p class="font-display font-bold text-dark-500 text-xs">Validaci&oacute;n</p></div>
          <div class="reveal stagger-8 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">8</span><span class="text-[9px] text-dark-200">Ses. 12</span></div><p class="font-display font-bold text-dark-500 text-xs">Decisi&oacute;n y Plan</p></div>
        </div>
      </div>
      <div data-lang="en">
        <div class="reveal flex items-center gap-3 mb-3">
        ...
        <h3 class="reveal font-display font-bold text-dark-400 text-[11px] uppercase tracking-[0.2em] mb-5"><i class="fas fa-route text-brand-400 mr-2"></i>8 Steps &mdash; 12 sessions of 60 min</h3>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
          <div class="reveal stagger-1 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">1</span><span class="text-[9px] text-dark-200">S. 1-2</span></div><p class="font-display font-bold text-dark-500 text-xs">Self-Discovery</p></div>
          <div class="reveal stagger-2 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">2</span><span class="text-[9px] text-dark-200">S. 3</span></div><p class="font-display font-bold text-dark-500 text-xs">Vocational Myths</p></div>
          <div class="reveal stagger-3 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">3</span><span class="text-[9px] text-dark-200">S. 4</span></div><p class="font-display font-bold text-dark-500 text-xs">Interest Test (RIASEC)</p></div>
          <div class="reveal stagger-4 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">4</span><span class="text-[9px] text-dark-200">S. 5-6</span></div><p class="font-display font-bold text-dark-500 text-xs">Pathway Exploration</p></div>
          <div class="reveal stagger-5 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">5</span><span class="text-[9px] text-dark-200">S. 7</span></div><p class="font-display font-bold text-dark-500 text-xs">Occupation Explorer</p></div>
          <div class="reveal stagger-6 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">6</span><span class="text-[9px] text-dark-200">S. 8-9</span></div><p class="font-display font-bold text-dark-500 text-xs">Research</p></div>
          <div class="reveal stagger-7 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">7</span><span class="text-[9px] text-dark-200">S. 10-11</span></div><p class="font-display font-bold text-dark-500 text-xs">Validation</p></div>
          <div class="reveal stagger-8 bg-white rounded-xl p-3.5 border border-beige-100 card-modern"><div class="flex items-center gap-2 mb-1.5"><span class="w-6 h-6 bg-brand-400 rounded-lg flex items-center justify-center text-white font-display font-black text-[10px]">8</span><span class="text-[9px] text-dark-200">S. 12</span></div><p class="font-display font-bold text-dark-500 text-xs">Decision &amp; Plan</p></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
  ...
  <div data-lang="en">
    ...
    <!-- Description -->
    <div class="reveal mb-10">
      <p class="text-dark-200 text-[15px] leading-[1.8] mb-5">The Development Research Group's AI/DD initiative will conduct a rigorous evaluation of an AI-powered intervention for senior secondary students in Lima, Peru, implemented by the Regional Directorate of Education of Lima (DRELM) as a World Bank Presidential Innovation Award. The study examines whether an adaptive math tutor and an AI career coach can improve learning outcomes and better align students' skills and career plans with labor market needs in key economic sectors. The intervention operates fully within existing teacher capacity, class hours, and school infrastructure.</p>
  ...
  <div id="tkContent" class="hidden max-w-5xl mx-auto">
    ...
    <div class="glass rounded-3xl p-6 border border-brand-400/15">
      ...
      <div class="grid sm:grid-cols-2 gap-3 text-xs text-white/40">
        ...
        <p><strong class="text-white/70"><i class="fas fa-check text-brand-400 mr-1.5"></i>60-min sessions max.</strong> Original 90-min was rejected. Respect local schedules.</p>
